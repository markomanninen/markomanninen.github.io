...
# Endless Forms build configuration file, created by
# `ablog start` on Mon Apr 03 11:06:27 2017.
#
...
blog_title = u'Endless Forms Blog'
...
blog_authors = {
    'Marko Manninen': ('Marko Manninen', None),
}
...
project = u'Endless Forms'
copyright = u'2017, Marko Manninen'
author = u'Marko Manninen'
...
htmlhelp_basename = 'EndlessFormsdoc'
